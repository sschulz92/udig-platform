...
/**
 * A caching feature source for fast data access.  This is an updated
 * copy of the CahcingFeatureSource in geotools 21 as it was remove
 * from geotools 22.
*/
/*
 *
...
public class CachingFeatureSource implements SimpleFeatureSource {
    ...
    public CachingFeatureSource(FeatureSource<SimpleFeatureType, SimpleFeature> original) throws IOException {
    ...
    Filter[] splitFilters(Query query) {
        ...
        List<Filter> bboxBacked = new ArrayList<>();
    ...
    public Set<RenderingHints.Key> getSupportedHints() {
    	Set<RenderingHints.Key> hints = new HashSet<>(wrapped.getSupportedHints());
    ...
    final class CachingFeatureCollection extends AbstractFeatureCollection {
        ...
        protected Iterator<SimpleFeature> openIterator() {
            ...
            if (query.getFilter() != null && Filter.INCLUDE.equals(query.getFilter())) {
                it = new FilteringIterator<SimpleFeature>(it, query.getFilter());
            }
    ...
    private class ReTypingIterator implements Iterator<SimpleFeature> {
