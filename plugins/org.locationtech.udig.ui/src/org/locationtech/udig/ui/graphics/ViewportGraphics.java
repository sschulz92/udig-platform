...
public interface ViewportGraphics {
     ...
     * <p>
     * Reference description from Graphics2d: <bq> Fills the interior of a <code>Shape</code>
     ...
     * <p>
     * Reference description from Graphics2d: <bq> Strokes the outline of a <code>Shape</code>
     * using the settings of the current <code>Graphics2D</code> context. The rendering attributes
     ...
     * @param sy2 - the y coordinate of the second corner of the source rectangle.
     */
    public void drawImage( org.eclipse.swt.graphics.Image swtImage, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1,
            int sx2, int sy2 );
     ...
     * <p>
     * If you need to make your drawing device independent please
     ...
     * <p>
     * Please note this is a change in behaviour over AWT (where
     * size is documented to be in 72 dpi. They are changing their
