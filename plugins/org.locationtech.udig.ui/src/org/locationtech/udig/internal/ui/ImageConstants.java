...
public interface ImageConstants {
    ...
    /** <code>NEW_WIZ</code> field */
    public static final String NEW_WIZ = PATH_ETOOL + "new_wiz.gif"; //$NON-NLS-1$
    ...
    public static final String FIRST_CO = PATH_ETOOL + "next_co.gif"; //$NON-NLS-1$
    /** <code>PREV_CO</code> field */
    public static final String PREV_CO = PATH_ETOOL + "prev_co.gif"; //$NON-NLS-1$
    /** <code>NEXT_CO</code> field */
    public static final String NEXT_CO = PATH_ETOOL + "next_co.gif"; //$NON-NLS-1$
    /** <code>LAST_CO</code> field */
    public static final String LAST_CO = PATH_ETOOL + "last_co.gif"; //$NON-NLS-1$
    ...
    /** <code>LOG_WIZ</code> field */
    public static final String LOG_WIZ = PATH_WIZBAN + "log_wiz.png"; //$NON-NLS-1$
